Shader "Custom/DepthQuadWireframe"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass {
            ...
            fixed4 frag(g2f i) : SV_Target
            {
                ...
                return fixed4(_WireframeBackColour.r*0.3, _WireframeBackColour.g*0.3, _WireframeBackColour.b*0.3, _WireframeBackColour.a*clamp(alpha*abs(_Intact-1),0,1));
            }
            ENDCG
            }
        Pass {
